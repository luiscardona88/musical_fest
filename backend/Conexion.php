...
class Conexion
{
  ...
  {
    $sig_index = (count($this->query) == 1) ? 1 : count($this->query) - 1;
    $index = (count($this->query) <= 0) ? 0 : $sig_index;
    $this->query[$index] = $query_param;
  }
  ...
  public function InitTransac($param1 = array(), $param2 = array())
  {
    ...
    try {
      ...
      $sentencia = $this->conn->prepare($this->getQuery(0));
      ...
      $sentencia = $this->conn->prepare($this->getQuery(1));
